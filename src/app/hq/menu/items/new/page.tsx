...
import { useMenuCategories, useAdminItems, useTags } from '@/hooks/useMenu';
            ...
            onSuccess: async (data: any) => {
              ...
              await Promise.all(
                selectedTagIds.map(tag_id =>
                  fetch(`/api/admin/menu/items/${itemId}/tags`, {
                    method: 'POST',
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="font-display font-bold text-2xl text-white">New Menu Item</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <label className="block cursor-pointer">
            ...
            {imagePreview ? (
              ...
              <div className="w-full aspect-video rounded-2xl border-2 border-dashed border-slate-700 flex flex-col items-center justify-center gap-2 hover:border-slate-500 transition-colors bg-slate-900">
                ...
                <p className="text-slate-600 text-xs">JPEG, PNG, WebP, AVIF · max 5 MB</p>
              </div>
            )}
          </label>
        </div>
        ...
        <div className="flex gap-3 pt-2">
          ...
          >
            {uploading || create.isPending ? 'Saving…' : 'Create Item'}
          </button>
